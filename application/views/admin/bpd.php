                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        <!-- Form Filter -->
                                        <div class="col-lg-8">
                                            <form action="<?php echo site_url('admin/bpd_filtered'); ?>" method="post" class="row align-items-end">
                                        ...
                                        <div class="col-lg-4 text-lg-right text-center mt-3 mt-lg-0">
                                            <a href="<?= site_url('admin/export_bpd'); ?>" class="btn btn-success btn-sm mr-2">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="dataBPD" class="table table-bordered table-hover table-striped small-table-font">
                                            <thead>
                                                <tr>
