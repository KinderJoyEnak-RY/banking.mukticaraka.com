                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">TMRW by UOB</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        <!-- Form Filter -->
                                        <div class="col-lg-8">
                                            <form action="<?php echo site_url('admin/uob_filtered'); ?>" method="post" class="row align-items-end">
                                        ...
                                        <div class="col-lg-4 text-lg-right text-center mt-3 mt-lg-0">
                                            <a href="<?= site_url('admin/export_uob'); ?>" class="btn btn-success btn-sm mr-2">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="dataUOB" class="table table-bordered table-hover table-striped small-table-font">
                                            <thead>
                                                <tr>
