                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo site_url('admin/uob'); ?>" class="nav-link active">
                                        <i class="nav-icon fas fa-credit-card sub-menu-icon"></i>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <div class="d-flex">
                                        <form action="<?php echo site_url('admin/uob_filtered'); ?>" method="post" class="d-flex align-items-center mr-3">
                                            <div class="mr-3">
                                        ...
                                        <a href="<?php echo site_url('admin/export_uob'); ?>" class="btn btn-success mr-2"><i class="fas fa-download"></i> Ekspor Semua Data</a>
                                        <button onclick="exportFilteredData()" class="btn btn-info"><i class="fas fa-filter"></i> Ekspor Data Terfilter</button>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="dataUOB" class="table table-bordered table-hover small-table-font">
                                            <thead>
                                                <tr>
    ...
    <script>
        function exportFilteredData() {
            ...
            if (startDate && endDate) {
                ...
                form.method = 'POST';
                form.action = '<?php echo site_url('admin/export_uob_filtered'); ?>';
