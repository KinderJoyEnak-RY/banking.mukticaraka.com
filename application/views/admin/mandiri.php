                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo site_url('admin/mandiri'); ?>" class="nav-link active">
                                        <i class="nav-icon fas fa-credit-card sub-menu-icon"></i>
                                        <p>BANK MANDIRI</p>
                                    </a>
                                </li>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        <!-- Form Filter -->
                                        <div class="col-lg-8">
                                            <form action="<?php echo site_url('admin/mandiri_filtered'); ?>" method="post" class="row align-items-end">
                                        ...
                                        <div class="col-lg-4 text-lg-right text-center mt-3 mt-lg-0">
                                            <a href="<?= site_url('admin/export_mandiri'); ?>" class="btn btn-success btn-sm mr-2">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="dataMANDIRI" class="table table-bordered table-hover table-striped small-table-font">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                if (!empty($mandiri_forms)) { // Cek apakah $bpd_forms tidak kosong
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<?php echo base_url('uploads/' . $form['ss_akun_dibuat']); ?>" target="_blank">Lihat ss akun dibuat</a>
                                                            </td>
                                                            <td>
                                                                <a href="<?php echo base_url('uploads/' . $form['ss_akun']); ?>" target="_blank">Lihat ss akun</a>
                                                            </td>
    ...
    <script>
        function exportFilteredData() {
            ...
            if (startDate && endDate) {
                ...
                form.method = 'POST';
                form.action = '<?php echo site_url('admin/export_mandiri_filtered'); ?>';
