            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="alert alert-warning alert-dismissible">
                        ...
                        Hallo <?php echo $this->session->userdata('name'); ?>, ini adalah dashboard ASM. selalu <a href="<?php echo site_url('user/logout'); ?>" class="alert-link">Logout</a> untuk keamanan akun Anda!
                    </div>
