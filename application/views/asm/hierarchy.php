...
<body class="hold-transition sidebar-mini">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo site_url('asm/hierarchy'); ?>" class="nav-link active">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            <?php foreach ($subordinates as $bsh) : ?>
                                                <tr>
                                                    <td>
                                                        <strong class="expandable">+BSH:</strong> <?php echo $bsh['name']; ?> (<?php echo $bsh['code']; ?>)
                                                        <table class="hidden">
                                                            <tr>
                                                                <td>
                                                                    <strong class="expandable">+ASM:</strong> <?php echo $bsh['asm']['name']; ?> (<?php echo $bsh['asm']['code']; ?>)
                                                                    <table class="hidden">
                                                                        <?php foreach ($bsh['asm']['koors'] as $koor) : ?>
                                                                            <tr>
                                                                                <td>
                                                                                    <strong class="expandable">+KOOR:</strong> <?php echo $koor['name']; ?> (<?php echo $koor['code']; ?>)
                                                                                    <table class="hidden">
                                                                                        <?php foreach ($koor['spvs'] as $spv) : ?>
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <strong class="expandable">+SPV:</strong> <?php echo $spv['name']; ?> (<?php echo $spv['code']; ?>)
                                                                                                    <table class="hidden">
                                                                                                        <?php foreach ($spv['sales'] as $salesperson) : ?>
                                                                                                            <tr>
                                                                                                                <td>
                                                                                                                    <strong class="expandable">+</strong> <?php echo $salesperson['level'] === 'DSR' ? 'DSR' : 'SDM'; ?>:</strong> <?php echo $salesperson['name']; ?> (<?php echo $salesperson['code']; ?>)
                                                                                                                    <table class="hidden">
                                                                                                                        <tr>
                                                                                                                            <td>CIMB: <?php echo $salesperson['total_data_cimb']; ?> <i class="fas fa-info-circle view-details" data-dsr-code="<?php echo $salesperson['code']; ?>" data-type="cimb"></i></td>
                                                                                                                            <td>UOB: <?php echo $salesperson['total_data_uob']; ?> <i class="fas fa-info-circle view-details" data-dsr-code="<?php echo $salesperson['code']; ?>" data-type="uob"></i></td>
                                                                                                                            <td>LINE: <?php echo $salesperson['total_data_line']; ?> <i class="fas fa-info-circle view-details" data-dsr-code="<?php echo $salesperson['code']; ?>" data-type="line"></i></td>
                                                                                                                            <td>BSI: <?php echo $salesperson['total_data_bsi']; ?> <i class="fas fa-info-circle view-details" data-dsr-code="<?php echo $salesperson['code']; ?>" data-type="bsi"></i></td>
                                                                                                                            <td>BPD: <?php echo $salesperson['total_data_bpd']; ?> <i class="fas fa-info-circle view-details" data-dsr-code="<?php echo $salesperson['code']; ?>" data-type="bpd"></i></td>
                                                                                                                            <td>MANDIRI: <?php echo $salesperson['total_data_mandiri']; ?> <i class="fas fa-info-circle view-details" data-dsr-code="<?php echo $salesperson['code']; ?>" data-type="mandiri"></i></td>
                                                                                                                            <td>BJJ DIGITAL: <?php echo $salesperson['total_data_bjj']; ?> <i class="fas fa-info-circle view-details" data-dsr-code="<?php echo $salesperson['code']; ?>" data-type="bjj"></i></td>
                                                                                                                        </tr>
                                                                                                                    </table>
                                                                                                                </td>
                                                                                                            </tr>
    ...
    <script>
        function fetchDetails(dsrCode, type) {
            $.ajax({
                url: '<?php echo site_url('asm/fetchDetails'); ?>',
                type: 'POST',
                data: {
                    dsrCode: dsrCode,
                    type: type
