...
<head>
    ...
    <title>Form Input Data CIMB NIAGA</title>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo site_url('dsr/cimb'); ?>">CIMB NIAGA</a></li>
                        ...
                        <div class="col-12">
                            <div class="card" style="height: 100%; padding: 10px;">
                                <div class="card-header text-center bg-green text-white">
                                    <strong>Form Input Data CIMB NIAGA</strong>
                                </div>
                                <div class="card-body" style="padding: 10px;">
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="no_mid">MID:</label>
                                        <small style="color:red; font-style:italic;">MID <b>ada di email</b> aktivasi</small>
