...
<body class="hold-transition sidebar-mini">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo site_url('dsr/line'); ?>" class="nav-link active">
                                        <i class="nav-icon fas fa-credit-card sub-menu-icon"></i>
                                        <p>LINE BANK</p>
                                    </a>
                                </li>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <a href="#" class="btn btn-primary mb-3" data-toggle="modal" data-target="#addLineModal">Add LINE Data</a>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="<?php echo base_url('uploads/' . $form['ss_detail_dashboard']); ?>" width="40" alt="SS Dashboard" class="img-thumbnail" data-toggle="modal" data-target="#imageModal" data-image="<?php echo base_url('uploads/' . $form['ss_detail_dashboard']); ?>">
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo site_url('dsr/delete_line/' . $form['id']); ?>" class="btn btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addLineModalLabel">Add LINE Data</h5>
                    ...
                    <div class="modal-body">
                        <div class="card">
                            <div class="card-body">
                                <?php echo form_open_multipart('dsr/add_line', array('id' => 'lineForm')); ?>
                                ...
                                <div class="form-group">
                                    <label for="ss_detail_dashboard">SS Detail Dashboard:</label>
                                    <input type="file" class="form-control" name="ss_detail_dashboard" id="ss_detail_dashboard" required>
                                </div>
                                <div class="form-group">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="submitBtn">Add LINE Data</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $("#submitBtn").click(function(e) {
            ...
            $.ajax({
                url: "<?php echo site_url('dsr/add_line'); ?>",
                type: "post",
                data: formData,
                processData: false,
                contentType: false,
