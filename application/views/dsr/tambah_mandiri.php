...
<head>
    ...
    <title>Form Input Data BANK MANDIRI</title>
...
<body class="hold-transition sidebar-mini">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo site_url('dsr/mandiri'); ?>" class="nav-link active">
                                        <i class="nav-icon fas fa-credit-card sub-menu-icon"></i>
                                        <p>BANK MANDIRI</p>
                                    </a>
                                </li>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo site_url('dsr/mandiri'); ?>">BANK MANDIRI</a></li>
                        ...
                        <div class="col-12">
                            <div class="card" style="height: 100%; padding: 10px;">
                                <div class="card-header text-center bg-green text-white">
                                    <strong>Form Input Data BANK MANDIRI</strong>
                                </div>
                                <div class="card-body" style="padding: 10px;">
                                    ...
                                    <!-- MANDIRI Form -->
                                    <?php echo form_open_multipart('dsr/add_mandiri', array('id' => 'mandiriForm')); ?>
                                    ...
                                    <div class="form-group">
                                        <label for="id_referral">ID Referral:</label>
                                        <input type="text" class="form-control" name="id_referral" id="id_referral" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="area_akuisisi">Area Akuisisi:</label>
                                        <!-- Input untuk melakukan pencarian pada dropdown -->
                                        <input type="text" id="searchInput" placeholder="Cari Kota">
                                        <select class="form-control" name="area_akuisisi" id="area_akuisisi" required>
                                            ...
                                            <option value="KOTAYOGYAKARTA">KOTA YOGYAKARTA</option>
                                            ...
                                            <option value="KABSEMARANG">KAB SEMARANG</option>
                                            <option value="KOTABANJAR">KOTA BANJAR</option>
                                    ...
                                    <div class="form-group">
                                        <label for="ss_akun_dibuat">SS Akun Berhasil Dibuat:</label>
                                        <input type="file" class="form-control" name="ss_akun_dibuat" id="ss_akun_dibuat" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="ss_akun">SS Akun Nasabah:</label>
                                        <input type="file" class="form-control" name="ss_akun" id="ss_akun" required>
                                    </div>
                                    <div class="form-group mt-4 d-flex justify-content-between">
                                        <a href="javascript:history.back()" class="btn btn-secondary">Cancel</a>
                                        <button type="submit" class="btn btn-primary">Add MANDIRI Data</button>
                                    </div>
                                    <?php echo form_close(); ?>
                                </div>
                            </div>
    ...
    <script>
        ...
        function filterDropdown() {
            ...
            select = document.getElementById("area_akuisisi");
        ...
        // Menambahkan event listener untuk memanggil fungsi filterDropdown() saat input diubah
