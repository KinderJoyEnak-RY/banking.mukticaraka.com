...
<head>
    ...
    <title>Form Input Data TMRW by UOB</title>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo site_url('dsr/uob'); ?>">TMRW by UOB</a></li>
                        ...
                        <div class="col-12">
                            <div class="card" style="height: 100%; padding: 10px;">
                                <div class="card-header text-center bg-green text-white">
                                    <strong>Form Input Data TMRW by UOB</strong>
                                </div>
