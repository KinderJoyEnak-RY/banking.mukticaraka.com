...
<head>
    ...
    <title>Form Input Data BPD DIY</title>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo site_url('dsr/bpd'); ?>">BPD DIY</a></li>
                        ...
                        <div class="col-12">
                            <div class="card" style="height: 100%; padding: 10px;">
                                <div class="card-header text-center bg-green text-white">
                                    <strong>Form Input Data BPD DIY</strong>
                                </div>
                                <div class="card-body" style="padding: 10px;">
                                    ...
                                    <div class="form-group mt-4 d-flex flex-column flex-sm-row justify-content-between">
                                        <a href="javascript:history.back()" class="btn btn-secondary mb-2 mb-sm-0">Cancel</a>
