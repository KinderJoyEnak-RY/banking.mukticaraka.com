        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <a href="<?php echo site_url('dsr/tambah_mandiri'); ?>" class="btn btn-primary mb-3">Add Mandiri Data</a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="mandiriTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">ID Referral</th>
                                            <th class="text-center">Nama Nasabah</th>
                                            <th class="text-center">No HP Nasabah</th>
                                            <th class="text-center">No Rek Nasabah</th>
                                            <th class="text-center">Area Akuisisi</th>
                                            <th class="text-center">SS Akun berhasil dibuat</th>
                                            <th class="text-center">SS Akun Nasabah</th>
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        if (!empty($mandiri_forms)) { // Cek apakah $mandiri_forms tidak kosong
                                            foreach ($mandiri_forms as $form) :
                                        ?>
                                                <tr>
                                                    <td><?php echo $no++; ?></td>
                                                    ...
                                                    <td><?php echo $form['id_referral']; ?></td>
                                                    ...
                                                    <td>
                                                        <img src="<?php echo base_url('uploads/' . $form['ss_akun_dibuat']); ?>" width="40" alt="SS akun berhasil Dibuat" class="img-thumbnail" data-toggle="modal" data-target="#imageModal" data-image="<?php echo base_url('uploads/' . $form['ss_akun_dibuat']); ?>">
                                                    </td>
                                                    <td>
                                                        <img src="<?php echo base_url('uploads/' . $form['ss_akun']); ?>" width="40" alt="SS Akun Nasabah" class="img-thumbnail" data-toggle="modal" data-target="#imageModal" data-image="<?php echo base_url('uploads/' . $form['ss_akun']); ?>">
                                                    </td>
                                                    <td><?php echo $form['spv']; ?></td>
                                                    <td><?php echo $form['koor']; ?></td>
                                                    <td><?php echo $form['asm']; ?></td>
                                                    <td>
                                                        <a href="<?php echo site_url('dsr/delete_mandiri/' . $form['id']); ?>" class="btn btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
