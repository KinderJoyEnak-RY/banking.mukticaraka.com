...
<head>
    ...
    <title>Form Input Data LINE BANK</title>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo site_url('dsr/line'); ?>">LINE BANK</a></li>
                        ...
                        <div class="col-12">
                            <div class="card" style="height: 100%; padding: 10px;">
                                <div class="card-header text-center bg-green text-white">
                                    <strong>Form Input Data LINE BANK</strong>
                                </div>
                                <div class="card-body" style="padding: 10px;">
                                    ...
                                    <div class="form-group mt-4 d-flex justify-content-between">
                                        ...
                                        <button type="submit" class="btn btn-primary">Add LINE Data</button>
                                    </div>
                                    <?php echo form_close(); ?>
                                </div>
                            </div>
