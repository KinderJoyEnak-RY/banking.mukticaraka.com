    ...
    <div class="wrapper">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <li class="nav-item">
                            <a href="<?php echo site_url('koor/dashboard'); ?>" class="nav-link active">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo site_url('koor/hierarchy'); ?>" class="nav-link">
        ...
        <div class="content-wrapper">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">KOOR Dashboard</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                <div class="container-fluid">
                    <!-- Bagian untuk menampilkan ringkasan data DSR -->
                    <div class="row">
                        <?php foreach ($dsrSummaries as $bank => $total) : ?>
                            <div class="col-md-4">
                                <div class="info-box bg-light">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number"><?php echo $total; ?> data entries</span>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
                    <!-- Akhir bagian ringkasan data DSR -->
            </section>
            <!-- /.content -->
        </div>
        <!-- /.content-wrapper -->
